    ...
    <div className="flex min-h-screen flex-col bg-background font-sans text-foreground">
      <header>
        ...
        <div className="w-full bg-foreground text-primary-foreground">
          <div className="flex min-h-16 items-center justify-center px-(--kauri-container)">
        ...
        {/* Main nav: logo left */}
        <nav className="flex w-full items-center justify-between border-b border-border bg-background px-(--kauri-container) py-[1.6rem]">
      ...
      {/* Main: launcher links */}
      <main className="flex flex-1 flex-col items-center justify-center px-(--kauri-container) py-24">
