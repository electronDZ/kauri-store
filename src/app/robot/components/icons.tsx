...
export function VideoPlaceholderIcon ({ className }: { className?: string }) {
  return (
    <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function CartEmptyIcon ({ className }: { className?: string }) {
  return (
...
export function ManualPaletteIcon ({ className }: { className?: string }) {
  return (
...
export function TrophyIcon ({ className }: { className?: string }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M6 6h12v4a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V9Z" />
...
export function FactoryIcon ({ className }: { className?: string }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M2 20V10l8-4v14" />
      <path d="M10 6l8-4v14l-8 4z" />
      <path d="M10 6v14" />
      <path d="M18 2v14" />
      <path d="M2 20h20" />
    </svg>
